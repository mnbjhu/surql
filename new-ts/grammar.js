module.exports = grammar({
  ...
  rules: {
    ...
    statement: $ => seq(choice(
      seq($._statement_start, repeat($._statement_argument)),
      $.expected_statement,
    ), ';'),
    ...
    _statement_argument: $ => choice(
      $._where_statement,
      $._content_statement,
      $._from_statement,
    ),

    where_statement: $ => prec(1, seq(
      $.where_token,
      $._value,
    )),
    ...
    _where_statement: $ => choice(
      $.where_statement,
      prec(-1, $.where_statement_missing_argument),
    ),

    content_statement: $ => prec(1, seq(
      $.content_token,
      $._value,
    )),
    ...
    _content_statement: $ => choice(
      $.content_statement,
      prec(-1, $.content_statement_missing_argument),
    ),

    from_statement: $ => prec(1, seq(
      $.from_token,
      $._table_name,
    )),
    ...
    _from_statement: $ => choice(
      $.from_statement,
      prec(-1, $.from_statement_missing_argument),
    ),

    select_statement: $ => prec(1, seq(
      $.select_token,
      $.value,
    )),
    ...
    _select_statement: $ => choice(
      $.select_statement,
      prec(-1, $.select_statement_missing_argument),
    ),

    create_statement: $ => prec(1, seq(
      $.create_token,
      $._table_name,
    )),
    ...
    _create_statement: $ => choice(
      $.create_statement,
      prec(-1, $.create_statement_missing_argument),
    ),



    update_statement: $ => prec(1, seq(
      $.update_token,
      $._table_name,
    )),
    ...
    _update_statement: $ => choice(
      $.update_statement,
      prec(-1, $.update_statement_missing_argument),
    ),

    delete_statement: $ => prec(1, seq(
      $.delete_token,
      $._table_name,
    )),
    ...
    _delete_statement: $ => choice(
      $.delete_statement,
      prec(-1, $.delete_statement_missing_argument),
    ),
    ...
    subtract: $ => prec.left(2, seq(
      $.value,
      '-',
      $.value,
    )),

    product: $ => prec.left(3, seq(
      $.value,
      '*',
      $.value,
    )),
    ...
    _table_name: $ => choice(prec(2, $.table_name), prec(1, $.expected_table_name)),
